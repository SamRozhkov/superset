...
<<<<<<< HEAD:superset-frontend/src/components/Select/AsyncSelect.test.tsx
...
=======
  ...
  expect(onChange).toHaveBeenCalledTimes(1);
  await userEvent.click(await findSelectOption(optionText));
>>>>>>> 6.0.0:superset-frontend/packages/superset-ui-core/src/components/Select/AsyncSelect.test.tsx
  expect(onChange).toHaveBeenCalledTimes(1);
});
