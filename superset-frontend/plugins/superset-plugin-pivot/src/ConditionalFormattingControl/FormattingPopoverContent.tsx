...
export const FormattingPopoverContent = ({
  ...
  const [isTotal, setIsTotal] = useState(config?.isTotal || false);
  ...
  return (
    ...
    >
      ...
      <Row gutter={12}>
        <Col span={6}>
          <FormItem name="isTotal" label="Is Total" initialValue={false}>
            <Checkbox checked={isTotal} onChange={changeIsTotal} />
          </FormItem>
        </Col>
      </Row>
