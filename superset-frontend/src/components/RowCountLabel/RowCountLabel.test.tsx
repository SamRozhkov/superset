...
<<<<<<< HEAD:superset-frontend/src/explore/components/RowCountLabel/RowCountLabel.test.tsx
  expect(tooltip).toHaveStyle('background: rgba(0, 0, 0, 0.902);');
=======
>>>>>>> 6.0.0:superset-frontend/src/components/RowCountLabel/RowCountLabel.test.tsx
});
