...
<<<<<<< HEAD:superset-frontend/src/components/Chart/DrillBy/DrillByMenuItems.test.tsx
  renderMenu({ drillByConfig: { filters: [], groupbyFieldName: 'groupby' } });
=======
  renderSubmenu({
    drillByConfig: { filters: [], groupbyFieldName: 'groupby' },
  });
>>>>>>> 6.0.0:superset-frontend/src/components/Chart/DrillBy/DrillBySubmenu.test.tsx
