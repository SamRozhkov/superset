...
const ChartHolder = ({
  ...
  return (
    <Draggable
      ...
      editMode={editMode}
    >
<<<<<<< HEAD:superset-frontend/src/dashboard/components/gridComponents/ChartHolder.tsx
      {({ dragSourceRef }) => (
        <ResizableContainer
          id={component.id}
          adjustableWidth={parentComponent.type === ROW_TYPE}
...
=======
      {renderChild}
>>>>>>> 6.0.0:superset-frontend/src/dashboard/components/gridComponents/ChartHolder/ChartHolder.tsx
    </Draggable>
  );
};
